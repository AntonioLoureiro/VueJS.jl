...
@el(r1,"revo-grid",value=rows,columns=columns,columnTypes=Dict("numeric"=>js"new NumberColumnType('0,0')","select"=> js"new SelectTypePlugin()"),cols=3) 
@el(r2,"revo-grid",value=df,cols=3) 
@el(r3,"revo-grid",value=df,cols=3) 
