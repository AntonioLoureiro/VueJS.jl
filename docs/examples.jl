...
side_actions_def = [
        Dict("title"=>"Query1", "val"=>Dict("query"=>"Query1",  "what"=>"www.google.com")),
        Dict("title"=>"Query2", "val"=>Dict("query"=>"Query2",  "what"=>"www.google.com"))]
...
page([[ch1,ch2,m1,m2, side_menu]], 
      methods=Dict("query_method"=>" function(what, query) {open('http://' + what + '/search?q=' + query, '_blank') }")) 
""",
"Basic Datatables"=>"""
df=DataFrame()
